...
@implementation TTTMiddleTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.centerButton.backgroundColor = [UIColor magentaColor];
        [self.centerButton setTitle:@"5" forState:UIControlStateNormal];
        ...
        self.leftButton.backgroundColor = [UIColor magentaColor];
        [self.leftButton setTitle:@"4" forState:UIControlStateNormal];
        ...
        [self.rightButton setTitle:@"6" forState:UIControlStateNormal];
